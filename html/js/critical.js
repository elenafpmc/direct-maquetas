!function(exports, global) {
    global["true"] = exports, !function(a, b) {
        ...
        windowWidth = $(window).width(), $(window).resize(function() {
            windowWidth = $(window).width();
        }), xsBreak = 480, smBreak = 768, mdBreak = 992, lgBreak = 1200, windowHeight = $(window).height(), 
        $(window).load(function() {
            $("#grid .bg").height($("body").height());
        }), $(window).load(function() {
            0 !== $('[data-spy="affix"]').length && $('[data-spy="affix"]').each(function() {
                affixHolderHeight = $(this).outerHeight(), affixID = $(this).attr("id"), $(this).wrap('<div id="' + affixID + '-holder" class="affix-holder"></div>'), 
                $(this).parent().height(affixHolderHeight), affixHolderOffset = $(this).offset().top - affixHolderHeight, 
            ...
            "true" == $(this).attr("data-controls") && ($(this).after('<button class="more" title="Aumentar">+</button>'), 
            $(this).before('<button class="less" title="Reducir">-</button>'));
        }), $(window).load(function() {
            sameHeight(), makeSquare(), autoHeightParent();
        }), $(window).resize(function() {
            sameHeight(), makeSquare();
        });
    }), $(function() {
        $.fn.datepicker.defaults.language = "es", $(".js-datepicker").datepicker({
            autoclose: !0,
            disableTouchKeyboard: !0
        });
        var anchoVentana = $(window).width();
        anchoVentana > 767 ? ($("#show-options-buttons").mouseenter(function() {
            $(this).hide(), $("#options-buttons").removeClass("hidden");
        }), $("#options-buttons").mouseleave(function() {
            $(this).addClass("hidden"), $("#show-options-buttons").show();
        })) : ($("#show-options-buttons").click(function(e) {
            e.stopPropagation(), $(this).hide(), $("#options-buttons").removeClass("hidden");
        }), $(document).click(function() {
            $("#options-buttons").addClass("hidden"), $("#show-options-buttons").show();
        })), $("#radio1").attr("checked", !0).parent().addClass("radio-sel"), $(":radio").change(function() {
            $(":radio[name=" + this.name + "]").parent().removeClass("radio-sel"), $(this).parent().addClass("radio-sel");
        }), $("#tabs-datospoliza").insertAfter("#tab-holder"), setTimeout(function() {
            !function() {
                fakewaffle.responsiveTabs([ "xs" ]);
            }(jQuery);
        }, 500), $(window).resize(function() {
            var anchoLayer = $(".content-holder").outerWidth(), anchoVentana = $(window).width();
            767 > anchoVentana ? ($(".selectedInfo .block-alert").css("width", anchoVentana - 30), 
            $(".selectedInfo .block-alert").css("left", -20)) : ($(".selectedInfo .block-alert").css("width", anchoLayer + 20), 
            $(".selectedInfo .block-alert").css("left", -30)), console.log(anchoVentana);
        });
    });
}({}, function() {
    return this;
